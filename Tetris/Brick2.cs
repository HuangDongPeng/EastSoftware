    ...
    class Brick2:Brick
    {
        ...
        public override bool CanTransform(int[,] arr, int rows, int columns)
        {
            ...
            break2:
                ...
                {
                    case 0:
                        arr[m_Pos.X, m_Pos.Y - 1] = color;
                        arr[m_Pos.X, m_Pos.Y] = color;
                        arr[m_Pos.X, m_Pos.Y + 1] = color;
                        arr[m_Pos.X, m_Pos.Y + 2] = color;
                        break;
                    case 1:
                        arr[m_Pos.X - 1, m_Pos.Y] = color;
                        arr[m_Pos.X, m_Pos.Y] = color;
                        arr[m_Pos.X + 1, m_Pos.Y] = color;
                        arr[m_Pos.X + 2, m_Pos.Y] = color;
                        break;
                    case 2:
                        arr[m_Pos.X, m_Pos.Y - 2] = color;
                        arr[m_Pos.X, m_Pos.Y - 1] = color;
        ...
        public override void Transform()
        {
            switch (m_curTransforIndex)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    m_range = new int[5, 5]{{0,0,color,0,0},
                                            {0,0,color,0,0},
                                            {0,0,color,0,0},
                                            {0,0,color,0,0},
                                            {0,0,0,0,0}};
