            ...
            for (int i = 0; i < m_curBrick.m_needfulRows; i++)
            {
                for (int j = 0; j < m_curBrick.m_needfulColumns; j++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            m_arr[realX, realY] = m_curBrick.color;
                        }
                    }
                }
            }
                    ...
                    if (arr[i, j] != 0)
                    {
                        switch (arr[i, j])
                        {
                            case 1:
                                ...
                                break;
                            case 2:
                                gra.FillRectangle(Brushes.Orange, j * itemwidth, i * itemheight, itemwidth - 2, itemheight - 2);
                                break;
                            case 3:
                                gra.FillRectangle(Brushes.Yellow, j * itemwidth, i * itemheight, itemwidth - 2, itemheight - 2);
                                break;
                            case 4:
                                gra.FillRectangle(Brushes.Green, j * itemwidth, i * itemheight, itemwidth - 2, itemheight - 2);
                                break;
                            case 5:
                                gra.FillRectangle(Brushes.HotPink, j * itemwidth, i * itemheight, itemwidth - 2, itemheight - 2);
                                break;
                            case 6:
                                gra.FillRectangle(Brushes.Purple, j * itemwidth, i * itemheight, itemwidth - 2, itemheight - 2);
                                break;
                            case 7:
                                gra.FillRectangle(Brushes.PowderBlue, j * itemwidth, i * itemheight, itemwidth - 2, itemheight - 2);
                                break;
