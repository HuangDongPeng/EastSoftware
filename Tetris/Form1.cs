...
namespace Tetris
{
    public partial class Form1 : Form
    {
        ...
        private void DrawItem(Graphics gb, int row, int column)
        {
            ...
            //if (m_canvas.m_arr[row, column] == 1)
            //    gb.FillRectangle(Brushes.Green, xpos, ypos, m_itemxlength - 2, m_itemylength - 2);
            //else 
            //    gb.FillRectangle(Brushes.Black, xpos, ypos, m_itemxlength - 2, m_itemylength - 2);

            switch (m_canvas.m_arr[row, column])
            {
                case 1:
                    gb.FillRectangle(Brushes.Red, xpos, ypos, m_itemxlength - 2, m_itemylength - 2);
                    break;
                case 2:
                    gb.FillRectangle(Brushes.Orange, xpos, ypos, m_itemxlength - 2, m_itemylength - 2);

                    break;
                case 3:
                    gb.FillRectangle(Brushes.Yellow, xpos, ypos, m_itemxlength - 2, m_itemylength - 2);
                ...
                case 4:
                    ...
                    break;
                case 5:
                    gb.FillRectangle(Brushes.HotPink, xpos, ypos, m_itemxlength - 2, m_itemylength - 2);
                    break; 
                case 6:
                    gb.FillRectangle(Brushes.Purple, xpos, ypos, m_itemxlength - 2, m_itemylength - 2);
                    break;
                case 7:
                    gb.FillRectangle(Brushes.PowderBlue, xpos, ypos, m_itemxlength - 2, m_itemylength - 2);
        ...
        //private void DrawItem(Graphics gb, int row, int column, Brush color)
        //{
        //    float xpos = column * m_itemxlength - 1;
        //    float ypos = row * m_itemylength - 1;
        //    gb.FillRectangle(color, xpos, ypos, m_itemxlength - 2, m_itemylength - 2);
        //}
